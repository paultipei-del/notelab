...
export default function SuccessContent() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: '#ECE3CC', borderRadius: '16px', border: '1px solid #D9CFAE', padding: '64px 56px', maxWidth: '480px', width: '90%', textAlign: 'center', boxShadow: '0 4px 32px rgba(26,26,24,0.10)' }}>
