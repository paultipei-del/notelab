// The same interval (C to G, a perfect fifth) shown two ways: as a melodic
// interval (notes played in succession) and as a harmonic interval (notes
// played simultaneously).

export const MELODIC_FIFTH_XML = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
...
export const HARMONIC_FIFTH_XML = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE score-partwise PUBLIC "-//Recordare//DTD MusicXML 4.0 Partwise//EN" "http://www.musicxml.org/dtds/partwise.dtd">
<score-partwise version="4.0">
  <part-list>
    <score-part id="P1"><part-name></part-name></score-part>
