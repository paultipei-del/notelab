  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F5F2EC' }}>
      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: '0 32px 64px' }}>
        ...
        {/* Glossary */}
        <div style={{ marginBottom: '48px' }}>
          <Link href="/glossary" style={{ textDecoration: 'none', display: 'block' }}>
            <div
              style={{ background: 'white', border: '1px solid #D3D1C7', borderRadius: '16px', padding: '28px 32px', cursor: 'pointer', transition: 'all 0.2s', boxShadow: '0 2px 12px rgba(26,26,24,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = '#BA7517'; e.currentTarget.style.transform = 'translateY(-2px)' }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = '#D3D1C7'; e.currentTarget.style.transform = 'translateY(0)' }}
            >
              <div>
                <span style={{ display: 'inline-block', fontSize: '10px', fontWeight: 400, letterSpacing: '0.12em', textTransform: 'uppercase', padding: '3px 10px', borderRadius: '20px', marginBottom: '12px', background: '#EDE8DF', color: '#888780' }}>Free</span>
                <h3 style={{ fontFamily: 'var(--font-cormorant), serif', fontWeight: 400, fontSize: '24px', color: '#1A1A18', marginBottom: '6px' }}>Glossary</h3>
                <p style={{ fontSize: '13px', fontWeight: 300, color: '#888780', lineHeight: 1.6, maxWidth: '480px' }}>
                  Searchable reference of musical terms — French, German, Italian, and common abbreviations.
                </p>
              </div>
              <span style={{ fontSize: '14px', fontWeight: 300, color: '#888780', marginLeft: '24px' }}>Browse →</span>
            </div>
          </Link>
        </div>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '13px', fontWeight: 300, color: '#888780', marginBottom: '20px' }}>
            Explore key signatures through the circle of fifths
          </p>
          <Link href="/key-signatures" style={{ textDecoration: 'none', display: 'block' }}>
            <div
              style={{ background: 'white', border: '1px solid #D3D1C7', borderRadius: '16px', padding: '28px 32px', cursor: 'pointer', transition: 'all 0.2s', boxShadow: '0 2px 12px rgba(26,26,24,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = '#BA7517'; e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 4px 32px rgba(26,26,24,0.10)' }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = '#D3D1C7'; e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 2px 12px rgba(26,26,24,0.06)' }}
            >
              <div>
                ...
                <p style={{ fontSize: '13px', fontWeight: 300, color: '#888780', lineHeight: 1.6, maxWidth: '480px' }}>
                  Navigate the circle of fifths, explore key signatures on treble and bass staves, and see which notes are affected on the keyboard.
                </p>
              </div>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '13px', fontWeight: 300, color: '#888780', marginBottom: '20px' }}>
            Identify notes on the staff by name — treble, bass, and grand staff
          </p>
          <Link href="/note-id" style={{ textDecoration: 'none', display: 'block' }}>
            <div
              style={{ background: 'white', border: '1px solid #D3D1C7', borderRadius: '16px', padding: '28px 32px', cursor: 'pointer', transition: 'all 0.2s', boxShadow: '0 2px 12px rgba(26,26,24,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = '#BA7517'; e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 4px 32px rgba(26,26,24,0.10)' }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = '#D3D1C7'; e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 2px 12px rgba(26,26,24,0.06)' }}
            >
              <div>
                ...
                <p style={{ fontSize: '13px', fontWeight: 300, color: '#888780', lineHeight: 1.6, maxWidth: '480px' }}>
                  Identify notes by name using letter buttons or a piano keyboard. Treble, bass, and grand staff — free range included, Pro unlocks all levels.
                </p>
              </div>
              <div style={{ marginLeft: '24px', flexShrink: 0 }}>
                <span style={{ fontSize: '14px', fontWeight: 300, color: '#888780' }}>Explore →</span>
