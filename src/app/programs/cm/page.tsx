      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: '40px 32px 80px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          <Link href="/programs" style={{ textDecoration: 'none' }}>
            <span style={{ fontFamily: F, fontSize: '12px', fontWeight: 300, color: '#888780', letterSpacing: '0.04em' }}>
              ← Programs
            </span>
          </Link>
        </div>
        ...
        <div style={{ marginBottom: '40px' }}>
          <p style={{ fontFamily: F, fontSize: '11px', fontWeight: 400, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#888780', marginBottom: '12px' }}>
          ...
          <p style={{ fontFamily: F, fontSize: '15px', fontWeight: 300, color: '#888780', maxWidth: '520px', lineHeight: 1.7, marginBottom: '0' }}>
          ...
          <div style={{
            ...
            <Link href="/account" style={{ textDecoration: 'none', flexShrink: 0 }}>
              <span style={{
                ...
                color: '#1A1A18', background: '#BA7517', borderRadius: '20px',
            ...
            if (locked) {
              return (
                <div
                  key={deck.id}
                  style={{
                    background: 'white', border: '1px solid #D3D1C7', borderRadius: '14px',
            ...
            return (
              <Link key={deck.id} href={`/study/${deck.id}`} style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <p style={{ fontFamily: SERIF, fontWeight: 400, fontSize: '17px', color: '#1A1A18', marginBottom: '0', lineHeight: 1.2 }}>{label}</p>
                </div>
              </Link>
            )
          })}
