  ...
  return (
    <div style={{ minHeight: '100vh', background: '#2C2A27' }}>
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: 'clamp(24px,4vw,40px) clamp(16px,4vw,32px) 80px' }}>
        ...
        <p style={{ fontFamily: F, fontSize: '13px', fontWeight: 300, color: '#9E9A92', margin: '0 0 40px', lineHeight: 1.6 }}>
          Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
        </p>

        <div style={{ background: '#353330', borderRadius: '16px', border: '1px solid #484542', padding: '32px' }}>
          <p style={{ fontFamily: F, fontSize: '13px', fontWeight: 300, color: '#9E9A92', lineHeight: 1.8, margin: 0 }}>
            ...
            <a href="/feedback" style={{ color: '#F0EDE6', textDecoration: 'underline' }}>feedback form</a>.
          </p>
        </div>
