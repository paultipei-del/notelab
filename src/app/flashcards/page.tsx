            ...
            <>
              ...
              <div className={s.desktopOnly}>
                <Shelf
                  ...
                  books={activeBooks}
                  info="A deck stays on this shelf until every card is mastered. Mastery means at least 2 successful reviews and a current spacing interval of 21 days or more. That's the threshold the spaced-repetition system uses to consider a card stable in long-term memory."
                />
                {topicShelves.map(t => (
