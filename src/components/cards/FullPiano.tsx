          ...
          return (
            <button
              ...
              style={{
                ...
                border: '1px solid ' + ((key.note === 'C' && key.octave === 4) ? '#B5402A' : '#D9CFAE'),
            ...
            >
              {isC && (
                <span style={{ fontSize: '8px', color: key.octave === 4 ? '#B5402A' : '#D9CFAE', fontFamily: 'var(--font-jost), sans-serif', userSelect: 'none', fontWeight: key.octave === 4 ? 400 : 300 }}>
                  C{key.octave}
                </span>
              )}
            </button>
