          ...
          return (
            <button
              ...
              style={{
                ...
                border: '1px solid ' + ((key.note === 'C' && key.octave === 4) ? '#B5402A' : '#DDD8CA'),
            ...
            >
              {isC && (
                <span style={{ fontSize: '8px', color: key.octave === 4 ? '#B5402A' : '#DDD8CA', fontFamily: 'var(--font-jost), sans-serif', userSelect: 'none', fontWeight: key.octave === 4 ? 400 : 300 }}>
                  C{key.octave}
                </span>
              )}
            </button>
