  ...
  return (
    <div style={{ marginBottom: '64px' }}>
      <div style={{ marginBottom: pageHero ? '40px' : '24px' }}>
        ...
        <p style={{ fontFamily: F, fontSize: pageHero ? '15px' : '13px', fontWeight: 300, color: '#888780', lineHeight: pageHero ? 1.7 : undefined, maxWidth: pageHero ? '560px' : undefined, margin: 0 }}>
          ...
          return (
            <div key={group.label}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', marginBottom: '16px', paddingBottom: '12px', borderBottom: '1px solid #E8E4DC' }}>
                <h3 style={{ fontFamily: F, fontSize: '11px', fontWeight: 400, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#1A1A18', margin: 0 }}>
                  {group.label}
                </h3>
