    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 16, justifyContent: 'center' }}>
        {choices.map(w => {
          ...
          let bg = 'white', border = '#DDD8CA', tc = DARK
          if (chosen !== null) {
