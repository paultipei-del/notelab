...
const HIDDEN_ON = ['/unlock', '/landing', '/metronome', '/tap-tempo', '/click-counter', '/sight-reading', '/glossary', '/repertoire', '/key-signatures', '/scale-builder', '/scale-fingerings', '/order-of-practice', '/note-chord-generator']
