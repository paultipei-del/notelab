...
export const NOTE_READING_MODULES: NRModuleDef[] = [
  ...
  },
  {
    ...
    description:
      'Read notes the way musicians actually read — as intervals from what came before. This is the foundation of sight-reading.',
    clef: 'grand',
  ...
  },
  {
    ...
    description:
      "Reading notes is only useful if you can read them in time. Combine pitch recognition with rhythm.",
    clef: 'treble',
