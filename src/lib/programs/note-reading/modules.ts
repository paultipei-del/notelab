...
// Drill mechanics variant. 'standard' is the Wave 1/2 single-pitch drill.
// 'intervallic' drills prompt for an interval relationship between two
// pitches (Module 8). 'rhythmic' drills use timed sequences (Module 9,
// not yet implemented). Modules default to 'standard' if unset.
export type NRVariant = 'standard' | 'intervallic' | 'rhythmic'
...
export const NOTE_READING_MODULES: NRModuleDef[] = [
  ...
  },
  {
    ...
    description:
      'All nine natural notes on the treble staff, from the bottom line to the top.',
    clef: 'treble',
  ...
  },
  {
    ...
    description:
      'All nine natural notes on the bass staff, from the bottom line to the top.',
    clef: 'bass',
  ...
  },
  {
    ...
    description:
      'Both clefs together. Switch between treble and bass reading on the fly.',
    clef: 'grand',
    notes: [
  ...
  },
  {
    ...
    description:
      'Notes beyond the staff — up to three ledger lines above treble and below bass.',
    clef: 'grand',
    notes: [
  ...
  },
  {
    ...
    description:
      'Notes with sharps and flats. Read the accidental and letter together as a single recognition.',
    clef: 'grand',
    notes: [
      // Treble sharps
  ...
  },
  {
    ...
    description:
      "Everything you've learned, at speed. Target: 95% accuracy in under 1.5 seconds per note.",
    clef: 'grand',
    notes: [
      // Treble naturals
  ...
  {
    id: 'intervallic-reading',
    title: 'Intervallic Reading',
    subtitle: 'Read by relation, not by position',
    description:
      'Read notes as intervals from a reference pitch — the foundation of sight-reading.',
    clef: 'grand',
    // Starting-pitch pool. Target pitches are generated by transposing
    // these by an interval (2nd through octave) up or down. The usable
    // staff range is C3–E5 so all targets stay on the grand staff.
    notes: [
  ...
  {
    id: 'rhythmic-sight-reading',
    title: 'Rhythmic Sight-Reading',
    subtitle: 'Notes in time with a metronome',
    description:
      'Pitch recognition meets rhythm. Four notes per measure, on the beat.',
    clef: 'treble',
